...
if st.button("Validate Now"):
    if raw_input:
        ...
        for word in words:
            ...
            if filtered_defs or instances or cambridge_data:
                ...
                with c2:
                    if not filtered_defs:
                        st.error("⚠️ No definitions match your selected levels — consider choosing a different word.")
